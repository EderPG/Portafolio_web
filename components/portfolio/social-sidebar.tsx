...
const socials = [
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/eder-uriel-palomino-garcia-325731291/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export function SocialSidebar() {
  return (
    <>
      ...
      <div className="hidden lg:flex fixed bottom-0 left-8 flex-col items-center gap-6 z-40">
        {socials.map((social) => (
          <a
            key={social.label}
            href={social.href}
